...
name: pm-init
description: >-
  Initialize local .pm governance workbench; detect new vs existing project; discover Spec Kit constitution; optional outline from intent. Trigger on /pm-init and related Chinese/English phrases for this command.
---
