...
name: pm-outline
description: >-
  Generate detailed project outline and draft charter from user intent (empty/new projects). Trigger on /pm-outline and related Chinese/English phrases for this command.
---
