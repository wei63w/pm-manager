...
name: pm-fix
description: >-
  Analyze pasted logs/stacks/slow SQL from chat (or --path) into bugs findings and todos. Trigger on /pm-fix and related Chinese/English phrases for this command.
---
