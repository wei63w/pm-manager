...
name: pm-all
description: >-
  Orchestrate full governance scan with prerequisite gates; default noise-filtered summary. Trigger on /pm-all and related English phrases for this command.
---
